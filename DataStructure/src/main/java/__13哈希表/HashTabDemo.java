...
class EmpLinkedList {
    ...
    public void add(Emp emp) {
        ...
        Emp curEmp = head;
        //说明到链表最后
        while (curEmp.next != null) curEmp = curEmp.next; //后移
        //退出时直接将emp 加入链表
        curEmp.next = emp;
    }
    ...
    public void list(int no) {
        ...
        while (true) {
            ...
            if (curEmp.next == null) break; //说明curEmp已经是最后结点
...
class HashTab {
    ...
    //遍历所有的链表,遍历hashtab
    public void list() {
        for (int i = 0; i < size; i++) empLinkedListArray[i].list(i);
    }
    ...
    public void findEmpById(int id) {
        ...
        if(emp != null) System.out.printf("在第%d条链表中找到 雇员 id = %d\n", (empLinkedListNO + 1), id);
        else System.out.println("在哈希表中，没有找到该雇员");
    }
}
